...
public class Communication {
    ...
    public CompletableFuture<Integer> start() {
        ...
        return connectionInitializer
                ...
                .thenApply((socketAddress) -> {
                    logger.info("Communication started and listening on {}.", socketAddress);
                    return socketAddress.getPort();
                })
                .whenComplete((integer, err) -> {
                    if (err != null) {
     ...
     * 收到消息后调用注册的回调
     */
    private void dispatchMessage(final PeerConnection connection, final String message) {
     ...
     * 收到指定code消息后调用指定回调
     */
    private void dispatchMessageByCode(final int code, final PeerConnection connection, final String message) {
